...
// D+100 같은 하루 단위 마일스톤(한 번뿐)과 생일(해마다 돌아옴)을 계산해서 돌려줍니다.
...
// 며칠째 되는 날을 기념하고 싶은지 (예: 50일, 100일, 200일, 300일 기념일)
const DAY_MILESTONES = [50, 100, 200, 300]
...
// DashboardBar의 "다음 기념일" 카드, Header의 알림 배지, 설정의 "기념일 추가" 목록이 같은 기준을 쓰도록 여기 한 곳에 모아둡니다.
